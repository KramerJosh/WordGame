...
const App = () => {
  ...
  const handleSubmit = () => {
    // first things first: we should also check if the currentGuess = the target word.
    ...
    // the second thing we need to check is whether there have already been 5 guesses
